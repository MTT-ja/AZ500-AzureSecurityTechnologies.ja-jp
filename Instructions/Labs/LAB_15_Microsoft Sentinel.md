...
10. **[分析ルール ウィザード - 新しいルールの作成]** ブレードの **[自動応答]** タブで、 **[Alert automation (classic)]\(アラートのオートメーション (クラシック)\)** ドロップダウン リストで **[Change-Incident-Severity ]** エントリの横にあるチェックボックスをオンにして、 **[次へ:確認>]** をクリックします。 
